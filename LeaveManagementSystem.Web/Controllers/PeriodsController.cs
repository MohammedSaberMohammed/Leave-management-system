...
namespace LeaveManagementSystem.Web.Controllers
{
    ...
    public class PeriodsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StartDate,EndDate")] Period period)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StartDate,EndDate")] Period period)
        {
            if (id != period.Id)
            {
                return NotFound();
